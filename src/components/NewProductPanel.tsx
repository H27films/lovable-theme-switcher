...
export default function NewProductPanel({ open, onClose, rate, onAdd }: NewProductPanelProps) {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 bottom-0 w-full max-w-[900px] z-[201] flex flex-col transform transition-transform duration-300 panel-bg" style={{ borderLeft: "1px solid hsl(var(--border-active))" }}>
        ...
        <div className="flex-1 overflow-y-auto p-10 scrollbar-thin">
          ...
          {/* Quantity — connected below CNY box */}
          <div className="surface-box border-t-0 p-5 pb-7 mb-8">
          ...
          {cnyVal > 0 && (
            <div className="mb-7">
              ...
              <div className={`grid gap-px price-grid-gap ${qtyVal > 0 ? "grid-cols-5" : "grid-cols-2"}`}>
                <div className="price-box-highlight py-6 px-4">
