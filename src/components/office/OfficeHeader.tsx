...
import { Menu, Tablet, Laptop, Settings as SettingsIcon, RefreshCw } from "lucide-react";
      ...
      <div style={{ position: "relative", flexShrink: 0 }} ref={dropdownRef}>
          ...
          {showDropdown && (
            <div style={{ position: "absolute", top: "44px", right: "0px", background: "hsl(var(--background))", border: "1px solid hsl(var(--border))", borderRadius: "8px", boxShadow: "0 4px 12px rgba(0, 0, 0, 0.15)", zIndex: 1000, minWidth: "160px", padding: "4px" }}>
              <button onClick={() => { setShowDropdown(false); onOpenSync?.(); }} style={{ display: "flex", alignItems: "center", gap: "8px", width: "100%", padding: "8px 12px", fontSize: "14px", fontWeight: 400, letterSpacing: "0.04em", color: "hsl(var(--foreground))", background: "none", border: "none", cursor: "pointer", fontFamily: "Raleway, sans-serif", textAlign: "left" }}>
