...
export const SettingsModal = ({ open, onClose, branch }: SettingsModalProps) => {
  const storageKey = `branch_custom_therapists_${branch.toLowerCase().replace(/\s+/g, '_')}`;
  ...
  return createPortal(
    <div
      ...
      style={{
        ...
        zIndex: 2000, background: "rgba(0,0,0,0.5)", backdropFilter: "blur(4px)",
    ...
    >
      <div
        ...
        style={{
          background: "hsl(var(--background))", borderRadius: "16px", padding: "24px",
          width: "100%", maxWidth: "380px", boxShadow: "0 10px 25px rgba(0,0,0,0.2)",
          border: "1px solid hsl(var(--border))", fontFamily: "Raleway, inherit"
        }}
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <SettingsIcon size={18} />
            <span style={{ fontSize: "15px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" }}>
              {branch} Settings
            </span>
          </div>
        ...
        <div style={{ marginBottom: "16px" }}>
            ...
            {therapists.map(name => (
              <div key={name} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 12px", background: "hsl(var(--card))", borderRadius: "8px", border: "0.5px solid hsl(var(--border))" }}>
                ...
                <button
                  ...
                  style={{ background: "none", border: "none", cursor: "pointer", color: "hsl(0 70% 50%)", padding: "2px" }}
                >
                  <Trash2 size={15} />
                </button>
              </div>
          ...
          <form onSubmit={handleAdd} style={{ display: "flex", gap: "8px" }}>
            <input
              ...
              style={{ flex: 1, background: "hsl(var(--card))", border: "1px solid hsl(var(--border))", borderRadius: "8px", padding: "10px 12px", fontSize: "14px", outline: "none", color: "hsl(var(--foreground))" }}
            />
            <button
              type="submit"
              style={{ background: "hsl(var(--foreground))", color: "hsl(var(--background))", border: "none", borderRadius: "8px", padding: "0 16px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}
            >
              <Plus size={18} />
            </button>
          </form>
        ...
        <button
          onClick={onClose}
          style={{ width: "100%", background: "hsl(var(--foreground))", color: "hsl(var(--background))", border: "none", borderRadius: "999px", padding: "12px", fontSize: "11px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", cursor: "pointer", marginTop: "8px" }}
        >
          Done
        </button>
      </div>
