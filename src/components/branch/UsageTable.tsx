              ...
              <div style={{ paddingTop: "12px", paddingBottom: "10px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "14px", minWidth: 0 }}>
                    <button onClick={() => cycleType(entry.id)} style={{ background: "#ffffff", color: "hsl(var(--foreground))", border: "0.5px solid hsl(var(--border))", cursor: "pointer", padding: "5px 12px", borderRadius: "999px", fontSize: "12px", fontWeight: 500, letterSpacing: "0.1em", fontFamily: "Raleway, inherit", textTransform: "uppercase" }}>{entry.type === "Salon Use" ? "Salon" : entry.type}</button>
                  ...
                  <button onClick={() => setUsageEntries(prev => prev.filter(e => e.id !== entry.id))} aria-label="Remove entry" style={{ background: "none", border: "none", cursor: "pointer", padding: "2px", color: "hsl(0 60% 35%)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <X size={16} />
                  </button>
                </div>
              </div>
