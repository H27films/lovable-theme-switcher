  ...
  <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
    ...
    >
      7 Days
            ...
            <LogTable rows={activeLog} selectedProduct={selectedProduct} onReverse={reverseRow} onUpdate={updateLogRow} viewType={selectedProduct ? "all" : logView} onEditModalChange={setEditModalOpen} branchDisplayName={nuryadiConfig.displayName} />
          </div>
        )}
      </div>
